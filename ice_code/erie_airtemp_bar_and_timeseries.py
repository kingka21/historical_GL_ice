...
df_tol = pd.read_csv("./data/toledo_all.csv",usecols=['DATE','TAVE'])
...
df_eri = pd.read_csv("./data/erie_all.csv",usecols=['DATE','TAVE'])
...
df_det = pd.read_csv("./data/detroit_all.csv",usecols=['DATE','TAVE'])
...
df_clv = pd.read_csv("./data/cleveland_all.csv",usecols=['DATE','TAVE'])
...
df_buf = pd.read_csv("./data/buffalo_all.csv",usecols=['DATE','TAVE'])
